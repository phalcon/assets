...
var o2 =
{
	...
	feautures:
	{
		...
		featureSlider: function()
		{
			...
			{
				var $sliderNav = $('.features-slider__nav');
				...
				var $sliderContent = $('.features-slider__content');
				/* Initializes a slick carousel only on mobile screens */
				// slick on mobile
				if ($(window).width() > 768)
				{
		...
		feauturesAccordion: function()
		{
			$('.features-accordion__trigger').click(function(e)
			{
				var $this = $(this);
		...
		feauturesTabs: function()
		{
			$('.features-nav__list li, .features-list__item').click(function(e)
			{
				var $this = $(this);
				...
				if($this[0] == $('.features-nav__list li.active')[0])
					$this.parents().find('.features__content').removeClass('active').eq($this.index()).addClass('active');
				else
					$this.parent().siblings('.feature').removeClass('active').eq($this.index()).addClass('active');
			});
		}
	}
}